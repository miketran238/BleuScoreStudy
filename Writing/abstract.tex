...
of migrated code (0.775 compared to 0.583 of BLEU score). The effectiveness of {\model} is also confirmed by its 
consistency with the decisions by the semantic correctness in comparing translation
models. With its advantages, {\model} could be used to evaluate SMT-based code 
migration~models.
