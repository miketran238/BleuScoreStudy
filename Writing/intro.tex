...
with semantic accuracy of the translated code. For second part, we
chose the two SMT-based models belonging to the two popular groups of
SMT: mppSMT~\cite{ase15}, which is based on phrase-based SMT, and
GNMT~\cite{gnmt}, which is based on neural network models.
%three most popular models: lpSMT~\cite{fse13-nier},
%mppSMT~\cite{ase15}, and GNMT~\cite{tien}.
