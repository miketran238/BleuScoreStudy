...
might result in considerable differences in term of semantic. This could lead to
...
mppSMT~\cite{ase15} and its artificial variant, p-mppSMT.
...
level representation that can be constructed for both versions. To
