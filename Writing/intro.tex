...
%Son drafted: (The intuition that motivates us to measure the results in 3 abstraction levels)
...
%code is not always constructed. Therefore, we propose a novel metric to evaluate...
% that integrate measure in three representation levels of source code: lexeme 
