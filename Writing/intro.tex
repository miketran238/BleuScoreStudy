...
Translate~\cite{googletranslate} is an SMT-based tool~that can accept
inputs and support text translation of over 100 languages. Microsoft Translator~\cite{mstranslator}
also supports instant translation for more than 60~languages.
...
different languages. For example, a mobile app could be
