...
0.95 and a null hypothesis that {\em the semantic scores of two models
  are equal}. According to t-test result, the t-critical value is 1.967 which implies the difference between semantic scores must be larger than 0.04 to be considered significant. The $p$-value (the probability that the results occurred by chance) of our test is 2.81E-85, which is much
